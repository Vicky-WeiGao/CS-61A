...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            currents = score1
        gain = currents - previous_score
        if gain > previous_high:
            if gain == 1:
                print("1 point!", "That's the biggest gain yet for Player",
                who)
            else:
                print(gain, "points!", "That's the biggest gain yet for Player",
                who)
            return announce_highest(who, gain, currents)
        return announce_highest(who, previous_high, currents)
    return say
    # END PROBLEM 7
